...
## Corpus Check
- 291 files · ~456,148 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1406 nodes · 2208 edges · 77 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 817 edges (avg confidence: 0.8)
...
Cohesion: 0.03
Nodes (16): MailArchiveQueryService, MailControllerTest, DocumentTypeCommandService, DocumentTypeCommandServiceTest, findById(), HrServiceClientFallback, DocumentTypeRepository, MailCategoryRepository (+8 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (13): MailAttachmentController, MailController, MailFolderController, MailRecipientController, PublicationController, MailQueryService, AllowedFileTypeController, DocumentTypeController (+5 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (18): PagedRequest, CacheSerializationTest, MailQueryCacheListener, ArchiveQueryRepository, DocumentTypeQueryRepository, MailCategoryQueryRepository, MailQueryRepository, MailTypeQueryRepository (+10 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (12): MailFolderControllerTest, isMovable(), isPersonalFolder(), MailFolderCommandService, MailFolderRepository, AuditTrailService, MailCommandService, RecipientMapper (+4 more)
...
Cohesion: 0.04
Nodes (13): MailFolder, MailFolderTest, MailRecipient, Publication, RecipientReadStatusListener, RecipientReadStatusListenerTest, AllowedFileType, DocumentType (+5 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (11): AttachmentFileStorageServiceTest, resolve(), PrintLog, PrintLogTest, PublicationControllerTest, PublicationCommandServiceImpl, PublicationFileStorageService, PublicationFileStorageServiceTest (+3 more)
...
- **Thin community `Community 21`** (11 nodes): `UserTaskRepository`, `.countByUserIdAndFolderIdAndReadStatus()`, `.emptyTrash()`, `.findActiveByUserIdAndMailId()`, `.findAllInTrashByMailId()`, `.findByUserIdAndMailId()`, `.purgeTrash()`, `.relocateMails()`, `.restoreFromTrash()`, `.updateFolder()`, `UserTaskRepository.java`
...
- **Thin community `Community 57`** (3 nodes): `MailCategoryStatistic.java`, `MailCategoryStatistic`, `.onUpdate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (3 nodes): `MessageTemplateRepository`, `.findByDescription()`, `MessageTemplateRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 64`** (3 nodes): `PublicationMapper`, `.toDto()`, `PublicationMapper.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (3 nodes): `MailResponseTimeListener`, `.onMailSent()`, `MailResponseTimeListener.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (3 nodes): `PublicationNotificationListener`, `.onPublished()`, `PublicationNotificationListener.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (3 nodes): `MailStatisticListener`, `.onMailSent()`, `MailStatisticListener.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (3 nodes): `JacksonConfig`, `.objectMapper()`, `JacksonConfig.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (3 nodes): `SecurityConfig`, `.filterChain()`, `SecurityConfig.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (3 nodes): `AppWritePropertiesConfig`, `.appWriteProperties()`, `AppWritePropertiesConfig.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (3 nodes): `WebClientConfig`, `.webClientBuilder()`, `WebClientConfig.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (3 nodes): `ArchiveNumberGenerator`, `.generate()`, `ArchiveNumberGenerator.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `ArchiveLocation`, `ArchiveLocation.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `MailRepository`, `MailRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `findById()` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 19`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `from()` connect `Community 2` to `Community 1`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 16`, `Community 18`?**
