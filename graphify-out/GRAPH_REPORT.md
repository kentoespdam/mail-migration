...
## Corpus Check
- 300 files · ~456,963 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1450 nodes · 2274 edges · 79 communities detected
...
Cohesion: 0.03
Nodes (18): PagedRequest, CacheSerializationTest, ArchiveQueryRepository, DocumentTypeQueryRepository, MailCategoryQueryRepository, MailQueryRepository, MailTypeQueryRepository, PublicationQueryRepository (+10 more)
...
Cohesion: 0.05
Nodes (14): ArchiveMapperImpl, ArchiveMapper, HasSqid, MailArchiveAccessTest, PublicationControllerTest, UserTask, fromValue(), PublicationNotifScheduler (+6 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (7): MailFolderControllerTest, isMovable(), isPersonalFolder(), MailFolderCommandService, MailFolderQueryService, FolderCounterRepository, MailFolderRepository

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (8): MailRecipientControllerTest, getData(), HrServiceClient, HrServiceClient, MailRecipientRepository, MailSendService, MailRecipientCommandService, MailRecipientCommandServiceTest

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (14): MailFolder, MailFolderTest, MailFolderMapperImpl, MailFolderMapper, AllowedFileType, DocumentType, MailCategory, MailCategoryTest (+6 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (10): PrintLog, PrintLogTest, jabatanId(), jabatanNama(), AuditTrailService, MailCommandService, RecipientMapperImpl, RecipientMapper (+2 more)
...
Cohesion: 0.14
Nodes (3): PublicationTest, QuickMessageTest, MailCategoryStatisticTest
...
- **Thin community `Community 25`** (9 nodes): `MessageTemplateController`, `.create()`, `.delete()`, `.findAll()`, `.findAllList()`, `.findById()`, `.MessageTemplateController()`, `.update()`, `MessageTemplateController.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (8 nodes): `AttachmentController`, `.AttachmentController()`, `.delete()`, `.download()`, `.findById()`, `.findByOwner()`, `.upload()`, `AttachmentController.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 32`** (5 nodes): `JooqConfig`, `.connectionProvider()`, `.dslContext()`, `.jooqConfiguration()`, `JooqConfig.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (5 nodes): `PublicationQueryHandler`, `.download()`, `.findAll()`, `.findById()`, `PublicationQueryHandler.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (4 nodes): `BooleanYesNoConverter.java`, `BooleanYesNoConverter`, `.convertToDatabaseColumn()`, `.convertToEntityAttribute()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (4 nodes): `MailArchiveNotif`, `.onCreate()`, `.onUpdate()`, `MailArchiveNotif.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (4 nodes): `MailResponseTime`, `.onCreate()`, `.onUpdate()`, `MailResponseTime.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (4 nodes): `MailArchiveNotifRepository`, `.findByArchiveId()`, `.findByPosId()`, `MailArchiveNotifRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (4 nodes): `MailResponseTimeRepository`, `.findByOriginalMailId()`, `.findByReplyMailId()`, `MailResponseTimeRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (4 nodes): `MailOrgStatisticQueryRepository`, `.findByPeriodMonth()`, `.MailOrgStatisticQueryRepository()`, `MailOrgStatisticQueryRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (4 nodes): `MailOrgStatisticRepository`, `.findByCreatedByOrg()`, `.findByPeriodMonth()`, `MailOrgStatisticRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (4 nodes): `MailTypeMapper`, `.toLookup()`, `.toResponse()`, `MailTypeMapper.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (4 nodes): `DocumentTypeMapper`, `.toLookup()`, `.toResponse()`, `DocumentTypeMapper.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (4 nodes): `ArchiveMapper`, `.toAccessResponse()`, `.toResponse()`, `ArchiveMapper.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (4 nodes): `ArchivePublishedEventListener`, `.ArchivePublishedEventListener()`, `.onArchivePublished()`, `ArchivePublishedEventListener.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (4 nodes): `MailNotificationListener`, `.onMailSent()`, `.sendNotificationToRecipient()`, `MailNotificationListener.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (4 nodes): `MailSentEventListener`, `.MailSentEventListener()`, `.onMailSent()`, `MailSentEventListener.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (4 nodes): `AsyncConfigurer`, `AsyncConfig`, `.getAsyncUncaughtExceptionHandler()`, `AsyncConfig.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (4 nodes): `MailNumberGenerator`, `.generate()`, `.supports()`, `MailNumberGenerator.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (3 nodes): `MailServiceApplication`, `.main()`, `MailServiceApplication.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (3 nodes): `SqidEntity`, `.getId()`, `SqidEntity.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (3 nodes): `MailArchiveNotifLog`, `.onCreate()`, `MailArchiveNotifLog.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 58`** (3 nodes): `MailActionLog`, `.MailActionLog()`, `MailActionLog.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (3 nodes): `MailArchiveRepository`, `.findActiveById()`, `MailArchiveRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (3 nodes): `MailActionLogRepository`, `.findAllByMailIdOrderByCreatedAtDesc()`, `MailActionLogRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (3 nodes): `MailCategoryStatisticRepository`, `.findByPeriodMonthAndCategoryId()`, `MailCategoryStatisticRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 75`** (2 nodes): `ArchiveLocation`, `ArchiveLocation.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (2 nodes): `MessageTemplateRepository`, `MessageTemplateRepository.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `findById()` connect `Community 2` to `Community 0`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 21`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `from()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 12`, `Community 17`, `Community 18`, `Community 20`?**
