...
## Corpus Check
- 281 files · ~455,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1352 nodes · 2110 edges · 78 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 764 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (19): MailAttachmentController, MailController, MailControllerTest, MailFolderController, MailRecipientController, PublicationController, isPersonalFolder(), MailFolderCommandService (+11 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (17): MailArchiveQueryService, CacheSerializationTest, MailArchiveController, DocumentTypeCommandService, DocumentTypeCommandServiceTest, findById(), isMovable(), HrServiceClientFallback (+9 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (18): PagedRequest, MailQueryCacheListener, ArchiveQueryRepository, DocumentTypeQueryRepository, MailCategoryQueryRepository, MailQueryRepository, MailTypeQueryRepository, PublicationQueryRepository (+10 more)
...
Cohesion: 0.05
Nodes (11): HasSqid, PublicationControllerTest, UserTask, PublicationNotifScheduler, MailFolderQueryService, FolderCounterRepository, PublicationRepository, PublicationCommandServiceImpl (+3 more)
...
Cohesion: 0.07
Nodes (9): MailArchiveCommandService, ArchiveNumberGenerator, MailRecipient, MailArchiveAccessRepository, MailArchiveNotifLogRepository, DefaultArchiveNumberGenerator, RecipientMapper, RecipientMapperImpl (+1 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (8): MailFolder, Publication, AllowedFileType, DocumentType, MailCategory, MailType, QuickMessage, SqidEntity
...
Cohesion: 0.09
Nodes (2): MailFolderControllerTest, MailFolderRepository
...
- **Thin community `Community 14`** (25 nodes): `.rename()`, `MailFolderControllerTest`, `.createFolder_shouldReturnCreated()`, `.deleteMail_shouldDelegateToService()`, `.emptyTrash_shouldDelegateToService()`, `.getCounters_shouldReturnCounterList()`, `.getFolderTree_shouldReturnFolderList()`, `.getMailsInFolder_shouldReturnMailList()`, `.moveMails_shouldDelegateToService()`, `.renameFolder_shouldReturnUpdatedFolder()`, `.restoreMail_shouldDelegateToService()`, `.sampleCounterResponse()`, `.sampleFolderResponse()`, `.sampleMailSummary()`, `.setUp()`, `.emptyTrash()`, `.renameFolder()`, `MailFolderRepository`, `.existsByOwnerIdAndName()`, `.existsByOwnerIdAndNameAndIdNot()`, `.findByOwnerIdAndParentFolderId()`, `.findByOwnerIdOrderByParentFolderIdAscIdAsc()`, `MailFolderRepository.java`, `MailFolderControllerTest.java`, `.purgeTrash()`
...
- **Why does `findById()` connect `Community 1` to `Community 0`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 13`, `Community 20`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `from()` connect `Community 2` to `Community 3`, `Community 4`, `Community 6`, `Community 9`, `Community 15`, `Community 16`, `Community 18`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `PageRequestMixin` connect `Community 17` to `Community 1`?**
