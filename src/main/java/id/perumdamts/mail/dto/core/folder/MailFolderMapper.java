...
public abstract class MailFolderMapper extends SqidMapper<MailFolder> {
    ...
    @Mapping(target = "parentFolderId", expression = "java(entity.getParentFolderId() != null ? encoder.encode(MailFolder.class, entity.getParentFolderId()) : null)")
    @Mapping(target = "ownerId", expression = "java(entity.getOwnerId() != null ? encoder.encode(MailFolder.class, entity.getOwnerId()) : null)")
