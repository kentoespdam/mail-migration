...
public class MailArchiveQueryService {
    ...
    public Page<ArchiveSummaryResponse> findForAdmin(ArchiveSearchRequest request) {
    ...
    public Page<ArchiveSummaryResponse> searchWithAcl(ArchiveSearchRequest request,
    ...
    public Page<ArchiveReportResponse> getReport(ArchiveReportRequest request) {
