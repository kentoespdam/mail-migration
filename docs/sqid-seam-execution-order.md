...
| # | Beads | Tipe | Slice | 🔒 Blocked by | Status |
|---|---|---|---|---|---|
| 3a | `mail-service-2kn` | AFK · P2 ⚠️ | Migrasi **Attachment** + fix `MailAttachmentController:62` (int) cast bug. Service signature naik konsisten ke `long` | `mail-service-83t` (2a) | [ ] |
